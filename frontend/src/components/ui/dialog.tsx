  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "max-md:inset-0 max-md:max-w-none max-md:h-full max-md:w-full max-md:translate-x-0 max-md:translate-y-0 max-md:left-0 max-md:top-0 max-md:rounded-none max-md:overflow-y-auto",
        className
      )}
      {...props}
    >
