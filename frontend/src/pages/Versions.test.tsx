...
vi.mock('../api', () => ({
  api: {
    versions: { list: vi.fn().mockResolvedValue([
      { id:1, name:'v1.0', phase:'', integration_date:'2026-07-01', freeze_date:'2026-07-10', test_date:'2026-07-12', release_date:'2026-07-20', note:'', current_phase:'已发布', created_at:'', updated_at:'' },
    ])},
